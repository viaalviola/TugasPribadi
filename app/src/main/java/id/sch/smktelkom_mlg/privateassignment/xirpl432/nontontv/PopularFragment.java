...
public class PopularFragment extends Fragment {
    ...
    private static final String URL_DATA = "https://api.themoviedb.org/3/tv/popular?api_key=2f986c307ef1caa39c17ab0870bec159";
    public List<PopularListItem> listItems;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new PopularAdapter(listItems, getActivity());
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        ...
                        try {
                            ...
                            adapter = new PopularAdapter(listItems, getActivity().getApplication());//apabila di acyvity getactivity hanya ditulis this saja.
                            recyclerView.setAdapter(adapter);
